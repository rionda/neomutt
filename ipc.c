...
int socket_create(void)
{
  ...
  Socket.msg.data.attach =
      (struct ListHead) STAILQ_HEAD_INITIALIZER(Socket.msg.data.attach);
  Socket.msg.data.bcc =
      (struct ListHead) STAILQ_HEAD_INITIALIZER(Socket.msg.data.bcc);
  Socket.msg.data.cc = (struct ListHead) STAILQ_HEAD_INITIALIZER(Socket.msg.data.cc);
  Socket.msg.data.config =
      (struct ListHead) STAILQ_HEAD_INITIALIZER(Socket.msg.data.config);
  Socket.msg.data.command =
      (struct ListHead) STAILQ_HEAD_INITIALIZER(Socket.msg.data.command);
  Socket.msg.data.folder =
      (struct ListHead) STAILQ_HEAD_INITIALIZER(Socket.msg.data.folder);
  Socket.msg.data.postponed = false;
  Socket.msg.data.query =
      (struct ListHead) STAILQ_HEAD_INITIALIZER(Socket.msg.data.query);
